...
Le site web déployé fonctionne avec ReactJs, ce qui explique la présence des dossiers nodes_modules, public, src ainsi que de package.json et package-lock.json 
